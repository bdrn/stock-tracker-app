...
- ABSOLUTELY NO markdown syntax - never use ** or __ or * or _ for bold/italic
- Use HTML tags ONLY: <strong>text</strong> for bold, <em>text</em> for italic
...
REMEMBER: Use <strong>HTML tags</strong> NOT markdown. Good: <strong>growth</strong> Bad: **growth**`;
